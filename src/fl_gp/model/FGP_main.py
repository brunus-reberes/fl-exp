...
x_train = numpy.load('f1_train_data.npy') / 255.0
y_train = numpy.load('f1_train_label.npy')
x_test = numpy.load('f1_test_data.npy') / 255.0
y_test = numpy.load('f1_test_label.npy')
